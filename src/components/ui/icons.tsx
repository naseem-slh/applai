...
/** Das Zahnrad der Kopfzeile. Es steht dort ohne Wort und braucht deshalb
 *  am Knopf ein übersetztes `aria-label` — siehe DESIGN.md, Sinnbilder. */
export const GearIcon = (props: IconProps) => <Icon d={PATHS.gear} {...props} />
